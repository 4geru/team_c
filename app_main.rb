  ...
  events.each { |event|
    ...
    when Line::Bot::Event::Message
      ...
      when Line::Bot::Event::MessageType::Text
        ...
        puts message.to_s
        puts "client.reply_message(event['replyToken'], message) = #{client.reply_message(event['replyToken'], message)}"
        puts "client.reply_message(event['replyToken'], message).body = #{client.reply_message(event['replyToken'], message).body}"
